...
contract NFTMarketplace is ERC721URIStorage{
    ...
    modifier onlyOwner{
        require(msg.sender == owner,"only the owner of the market place can change the 
        listing price");
        _;
    }
    constructor() ERC721("NFT Mrtaverse Token","MYNFT")
    {
...
// CREATING MARKET ITEMS
    function createMarketItem(uint256 tokenId, uint256 price) private{
        require(price > 0, "price must be atleast greater than 0");
        ...
        emit idMarketItemCreated(tokenId,msg.sender,adderss(this),price,false);
    } 
    ...
    function createMarketSale(uint256 tokenId) public payable{
        uint price = idMarketItem[token].price;
        require(
            msg.value == price , 
    ...
    function fetchMarketItem() public view returns(MarketItem[] memory)
    {
        ...
        uint256 unSoldItemCount = _tokenIds.current() - itemSold.current();
...
contract NFTMarketplace is ERC721URIStorage {
    ...
    // CREATING MARKET ITEMS
    function createMarketItem(uint256 tokenId, uint256 price) private {
        require(price > 0, "Price must be at least greater than 0");
        require(msg.value == listingPrice, "Price must be equal to listing price");
    ...
    function reSellToken(uint256 tokenId, uint256 price) public payable {
        require(idMarketItems[tokenId].owner == msg.sender, "Only item owner can perform this operation");
